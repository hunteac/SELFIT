    ...
    <div class="container-login100">
      <div class="wrap-login100">
        <form v-on:submit.prevent="join" class="login100-form validate-form">
          ...
          <!-- <div v-show="!chkSame" style="color: #f00; font-weight: bold">
            비밀번호가 일치하지 않습니다.
          </div>
          <div v-show="chkSame">올바른 비밀번호입니다.</div>
          <div v-show="chkSame">
            특수문자, 문자, 숫자로 이루어진 8~12자리의 비밀번호를 작성해주세요.
          </div> -->
...
// const chkSame = ref(false);

// 자바스크립트 정규식 확인
watch(pwd, (newValue) => {
  console.log("regest: " + regex.test(newValue));
  console.log(newValue);
  pwdRegex.value = regex.test(newValue);
});

// watch(chkSame, () => {
//   if (pwdChk != "" && pwd == pwdChk) {
//     chkSame = true;
//   } else {
//     chkSame = false;
//   }
